<?php
    ...
    if(isset($_POST['submit']))
    {
        foreach($_POST['reponse'] as $id=>$reponse)
        {
            ...
            $sql="insert into record_permission(nom,prenom,departement,reponse)values('$nom','$prenom','$departement','$reponse')";
    ...
    <div class="container">
        ...
        <?php if($flag) { ?>
            <div class="alert alert-success">
                Reponse au demande de permission sont ajouter!
            </div>
            <?php } ?>
    </div>
    <div class="container">
    <div class="panel panel-default">
        <div class="panel-heading">
            <div class="panel panel-body">
                <form action="repondrepermission.php" method="post">
                    <table class="table table-striped">
                        <tr>
                        <th>Id</th><th>Nom</th><th>Prénom</th><th>N°tel</th><th>Departement</th><th>Jour</th><th>Heure_sortie</th><th>Heure_rentrer</th><th>Cause</th><th>Repondre</th>
                        </tr>
                        <?php
                        $id=0; 
                        $counter=0;
                        ...
                        <tr>
                            ...
                            <td><?php echo $row['heure_rentrer'];?></td>
